...
def build_ytdl_options(client):
    ...
    options = {
        ...
        # สำคัญ:
        # ไม่กำหนด format เพื่อให้ yt-dlp
        # เลือก format ที่มีอยู่จริง
        ...
        try:
            ...
            await loading.edit(
                ...
                content=(
                    "❌ ไม่สามารถดึงเพลงจาก "
                    "YouTube ได้ครับ\n\n"
                    "ส่ง Log ล่าสุดมาให้ผมตรวจได้ครับ"
                )
            )
